...
import { type FileFormatCategory } from '../file-format/model.js';
import { type FileToMediaRelationship } from '../file-to-media/model.js';
import { type MediaTableSchema } from './sqlite.table.js';

type MediaSelection = Selectable<MediaTableSchema>;
type MediaInsertion = Insertable<MediaTableSchema>;
