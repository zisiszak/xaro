 ...
 */
export const checkAnyExist = <DB, TB extends keyof DB, O>(
	qb: SelectQueryBuilder<DB, TB, O>,
) => qb.executeTakeFirst().then((result) => result !== undefined);
 ...
 */
export const checkOnlyOneExists = <DB, TB extends keyof DB, O>(
	qb: SelectQueryBuilder<DB, TB, O>,
) =>
	qb
		.limit(2)
